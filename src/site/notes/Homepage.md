...
My research passion lies in understanding numerical behaviors and ensuring numerical correctness, especially in high-performance accelerators like NVIDIA and AMD GPUs. I delve deep into topics such as Floating-point Error and Exception Analysis, High-Performance Computing B,inary Instrumentation, Tensor Core Numerical Behavior and Systematic Reverse-Engineering of Numerical Behavior.
